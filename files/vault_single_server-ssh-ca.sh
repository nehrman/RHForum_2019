...
echo "# Generate CA Signing Key"
echo "-------------------------"

vault write -f ssh-ca-client-signer/config/ca

echo "# Create simple role used by SSH-CA"
echo "-----------------------------------"

vault write ssh-ca-client-signer/roles/rhforum2019 -<<"EOH"
{
